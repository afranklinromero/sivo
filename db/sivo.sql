...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-10-2019 a las 00:27:21
...
(1, 'CARDENAL CUSHING JESUS MARIA', 1, 4021),
(2, 'CORONEL IGNACIO WARNES', 1, 4022),
(3, 'DANIEL RIVERO', 1, 4023),
(4, 'JULIO A. GUTIERREZ', 1, 4017),
(5, 'CLUB DE LEONES #6', 1, 4018),
(6, 'LORENZO CABALLERO', 1, 4019),
(7, 'PLACIDO MOLINA', 1, 4005),
(8, 'FE Y ALEGRIA LA MERCED', 1, 4000),
(10, 'JHON KENNEDY', 2, 4014),
(11, 'VILLA ROSARIO', 2, 4002),
(12, 'LA MADRE', 2, 4003),
(13, 'SARA PORRAS DE PINTO', 2, 10017),
(14, 'AMBROCIO VILLARROEL', 2, 10016),
(15, 'JOSE MALKY JESUS MARIA', 3, 4012),
(16, 'NUCLEO ESCOLAR RAMAFA', 3, 4013),
(17, 'COMPLEJO EDUCATIVO JAPON', 3, 4015),
(18, 'COL. ALFA Y OMEGA', 3, 4016),
(19, 'EL CARMEN 16 DE JULIO', 3, 4008),
(20, 'ANTONIO VICENTE SEOANE', 3, 4020),
(21, 'SOCIEDAD DE INGENIEROS', 3, 4004),
(22, 'VICTOR PAZ ESTENSORO', 3, 4011),
(23, 'MONSENOR LUIS RODRIGUEZ P.', 3, 4010),
(24, 'HENRRY PRINCE', 3, 4007),
(25, 'VILLA FATIMA', 3, 4009),
(26, 'AMERICAN SCHOOL COOP.', 3, 4006),
(27, '24 DE SEPTIEMBRE', 4, 25444),
(29, 'LA COLINA', 4, 10002),
(30, '29 DE DICIEMBRE', 4, 10003),
(31, 'HILANDERIA', 4, 10004),
(32, 'DOMINGO SAVIO - DON BOSCO', 4, 9008),
(33, 'LA BASE', 4, 10015),
(34, 'EL PROGRESO', 4, 10018),
(35, 'MODULO FLAMINGO', 4, 10014),
(36, 'HERMANOS CAVANIS', 4, 10012),
(37, 'UNZAGA DE LA VEGA', 4, 5),
(39, 'OSCAR ARNULFO', 4, 10),
(40, 'ANITA SUAREZ DE LEYGUE', 4, 10011),
(41, 'MELVIN JONES', 3, 25666),
(42, 'UNION PROGRESO', 4, 10001),
(43, 'JARDIN LATINO', 4, 25443),
(44, 'SANTA ANA C', 4, 25442),
(45, 'JORGE URENDA TRIGO', 4, 10007);
...
--
ALTER TABLE `mesas`
  MODIFY `id_mesa` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=745;

--
-- AUTO_INCREMENT de la tabla `recintos`
--
ALTER TABLE `recintos`
  MODIFY `id_recinto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
